...
export const FUN_FACTS: FunFact[] = [
  ...
  { id: 'i11', title: 'Aggregator Role', fact: 'Payment aggregators help merchants accept digital payments without building their own payment stack.', why: 'They simplify integration for thousands of merchants.', difficulty: 'Intermediate' },
  { id: 'i26', title: 'Mostly P2P', fact: 'Most UPI transactions in India are person-to-person payments.', why: 'Splitting bills and paying friends still dominates everyday usage.', difficulty: 'Intermediate' },
  { id: 'i27', title: 'Reconciliation Partners', fact: 'Companies such as Razorpay and Cashfree help businesses manage payment collection and reconciliation.', why: 'Merchants get one dashboard instead of juggling every bank separately.', difficulty: 'Intermediate' },
